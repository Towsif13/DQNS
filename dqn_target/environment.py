...
class Environment:
    ...
    def __init__(self, w=WIDTH, h=HEIGHT):
        ...
        self.constant = 100
        self.alpha = 0.01
        # self.MAN_INITIAL_X = 0
        # self.MAN_INITIAL_Y = 0
    ...
    def step(self, action):
        ...
        return np.array([self.drone_x, self.drone_y, self.MAN_INITIAL_X, self.MAN_INITIAL_Y]), self.reward, self.done
...
# print(pos)
# for i in range(20):
#     rand_pos = np.random.choice(pos)
#     print(rand_pos)

# # %%
# distance = [i for i in range(0, 201, 20)]
# print(distance)
# for i in (distance):
#     if i == 0:
#         continue
#     reward_curr = round(math.log(100.0/(0.01*i)), 2)
#     print(i, reward_curr)
